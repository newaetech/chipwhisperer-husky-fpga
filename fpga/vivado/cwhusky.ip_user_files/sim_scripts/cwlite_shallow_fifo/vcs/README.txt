...
#
# Generated by export_simulation on Thu Feb 11 11:10:38 -0500 2021
#
################################################################################
...
'-reset_run' switch to the './cwlite_shallow_fifo.sh' script.

./cwlite_shallow_fifo.sh -reset_run
...
./cwlite_shallow_fifo.sh -noclean_files

For more information on the script, please type './cwlite_shallow_fifo.sh -help'.
