...
HD_PWD='C:/Users/jp/GitHub/OpenTitan/husky/fpga/vivado/cwhusky.runs/cwlite_shallow_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cwlite_shallow_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cwlite_shallow_fifo.tcl
